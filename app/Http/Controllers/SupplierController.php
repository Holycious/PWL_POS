...
class SupplierController extends Controller
{
    ...
    public function list()
    {
        ...
        return DataTables::of($suppliers)->addIndexColumn()->addColumn('aksi', function ($supplier) {
            ...
            $btn = '<a href="' . route('supplier.show' , $supplier->supplier_id) . '" class="btn btn-info btn-sm">Detail</a> ';
    ...
    public function export_excel()
     {
         ...
         $barang = SupplierModel::select('supplier_kode', 'nama', 'alamat')
             // ->orderBy('kategori_id')
             // ->with('kategori')
             ->get();
         // load library excel
     ...
     {
         $supplier = SupplierModel::select('supplier_kode', 'nama', 'alamat')
             // ->orderBy('kategori_id')
             // ->orderBy('barang_kode')
             // ->with('kategori')
             ->get();
